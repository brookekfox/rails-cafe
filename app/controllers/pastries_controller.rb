class PastriesController < ApplicationController
  ...
  # GET /pastries
  # GET /pastries.json
  def index   #list multiple instances of this class
    @pastries = Pastry.all #every pastry object in the Pastry class
  end

  # GET /pastries/1
  # GET /pastries/1.json
  def show  #individual instance's page
  end

  # GET /pastries/new
  def new   #create a new instance; the new view probably shows a form
    @pastry = Pastry.new
  end
  ...
  private #protects the controller actions in here from the users
